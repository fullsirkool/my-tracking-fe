...
import type { IChallengeIndividualRegisterInfo } from '~/types/dto/challenge.dto'
...
const form = reactive<Partial<IChallengeIndividualRegisterInfo>>({
  email: '',
  phoneNumber: '',
  name: '',
  address: '',
...
const v$ = useVuelidate(
  rules,
  form as Required<IChallengeIndividualRegisterInfo>,
)
...
const onRegister = async () => {
  try {
    ...
    const { data, error } = await challengeRepository.joinChallengeAsIndividual(
      {
        ...(form as IChallengeIndividualRegisterInfo),
